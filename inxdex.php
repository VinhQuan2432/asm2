...
<header class="w3-display-container w3-content w3-wide" style="max-width:1600px;min-width:500px" id="home">
  <img class="w3-image" src="image/web_du_an.jpg" alt="Toys" width="1200" height="500">
  <div class="w3-display-bottomleft w3-padding-large w3-opacity">
    <h1 class="w3-xxlarge">ATN Shop</h1>
  </div>
</header>
...
<p>Design by: Lam Thai Duy</p>
  <p>Contact information: <a href=https://www.facebook.com/profile.php?id=100005365575003&ref=bookmarks>Mai Vinh Quan</a>.</p>
